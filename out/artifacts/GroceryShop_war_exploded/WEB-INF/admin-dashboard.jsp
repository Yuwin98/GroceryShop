...
<body>
    ...
    <%
       ...
       String path = request.getContextPath() + "/images/users/" + user.getPath();
    ...
    <div class="info-cards">
        <div class="info-card">
            <h3 class="info-card-title">Orders</h3>
            <h2 class="info-card-value">500 <span class="info-card-sub">Orders today</span></h2>
        </div>
        <div class="info-card">
            <h3 class="info-card-title">Revenue</h3>
            <h2 class="info-card-value">Rs.20530 <span class="info-card-sub">Today so far</span></h2>
        </div>
        <div class="info-card">
            <h3 class="info-card-title">Users</h3>
            <h2 class="info-card-value">124 <span class="info-card-sub">New users</span></h2>
        </div>
        <div class="info-card">
            <h3 class="info-card-title">Views</h3>
            <h2 class="info-card-value">817 <span class="info-card-sub">Page Views today</span></h2>
        </div>
    ...
    <table class="table-users">
            ...
            %>
                ...
                <tr class="user-data">
                    ...
                    <td><table><% for(String item : items){ %>
                            <tr><td><%=item%></td></tr>
                        <% } %>
                        </table>
                    </td>
